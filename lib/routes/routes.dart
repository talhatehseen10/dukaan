...
import 'package:dukaan/views/address/bindings/customer_address_binding.dart';
import 'package:dukaan/views/address/views/customer_address.dart';
...
import 'package:dukaan/views/check_out/bindings/check_out_binding.dart';
import 'package:dukaan/views/check_out/views/check_out.dart';
...
import 'package:dukaan/views/my_bag/bindings/my_bag_binding.dart';
import 'package:dukaan/views/my_bag/views/my_bag.dart';
import 'package:dukaan/views/order/bindings/order_binding.dart';
import 'package:dukaan/views/order/bindings/order_detail_binding.dart';
import 'package:dukaan/views/order/views/order.dart';
...
import 'package:dukaan/views/profile/bindings/profile_binding.dart';
import 'package:dukaan/views/profile/views/profile.dart';
